- Every object in js has this property called prototype

console.log(Array.prototype); //check in console
const dog = {
  barks: true
};

console.log(Object.getPrototypeof(dog)); //check in console
console.log(Function.getPrototypeof(dog)); 
=================================================================================================
...
--> What is Inheritance of an Object in Javascript?
  ...
  inheritance means one object can access properties and methods of another object through the prototype chain.

  JavaScript does not copy properties into the new object.Instead, it links objects together.
...
object2 has only one own property { name: 'Shiv' }

object1 becomes the prototype of object2

When JavaScript looks for object2.city: ❌ Not found on object2 , ✅ Found on object1 (its prototype)

JavaScript automatically walks up the prototype chain
